...
void GameManager::Init() {
	...
	bg			 = &BGManager::GetInst();
	menuMng		 = &MenuManager::GetInst();
	tutorialStg	 = &TutorialStage::GetInst();
	endlessStg	 = &EndlessStage::GetInst();
	laserMng	 = &LaserManager::GetInst();
	meteorMng	 = &MeteorManager::GetInst();
	ripples		 = &Ripples::GetInst();
	fireworksMng = &FireworksManager::GetInst();
	item		 = &ItemManager::GetInst();
	player		 = &Player::GetInst();
	effectMng	 = &EffectManager::GetInst();
	uiMng		 = &UIManager::GetInst();
