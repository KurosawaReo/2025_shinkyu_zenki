...
#define ORDER_METEOR_MNG				(4)
#define ORDER_NOR_LASER_MNG				(5)				//Normal Laser  (通常レーザー)
#define ORDER_STR_LASER_MNG				(6)				//Straight Laser(直線レーザー)
#define ORDER_RIPPLES_MNG				(7)
#define ORDER_FIREWORKS_MNG				(8)
#define ORDER_LASER_MNG					(9)
#define ORDER_ITEM_MNG					(10)
#define ORDER_PLAYER_MNG				(11)
#define ORDER_EFFECT_MNG				(12)
#define ORDER_UI_MNG					(13)
